...
import 'package:nowastocktaking/pages/splash_screen.dart';
import 'package:nowastocktaking/pages/home_page.dart';
import 'package:nowastocktaking/pages/sign_in_page.dart';
...
class _AuthWrapperState extends State<AuthWrapper> {
  ...
  Future<void> _checkAuthentication() async {
    try {
      ...
      const minSplashDuration = const Duration(milliseconds: 700);
