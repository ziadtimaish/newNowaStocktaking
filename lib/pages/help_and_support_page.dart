...
class _HelpAndSupportPageState extends State<HelpAndSupportPage> {
  final List<Map<String, String>> _faqItems = [
    ...
    },
    {
      ...
      'answer':
          'Go to the Audit page and tap the export button. You can choose from PDF or Excel formats for your reports.',
    },
    {
    ...
    },
    {
      ...
      'answer':
          'Yes, you can invite team members through the Settings page. Each user will have their own login credentials.',
    },
  ];
